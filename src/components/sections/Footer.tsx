    ...
    <footer className="text-center px-0 py-10">
      <div className="mb-10">
        ...
        <div className="flex justify-center gap-5 max-sm:flex-wrap">
          <a href="#" aria-label="Facebook" className="transition-transform duration-300 hover:rotate-[360deg]">
          ...
          <a href="#" aria-label="Instagram" className="transition-transform duration-300 hover:rotate-[360deg]">
          ...
          <a href="#" aria-label="LinkedIn" className="transition-transform duration-300 hover:rotate-[360deg]">
          ...
          <a href="#" aria-label="Twitter" className="transition-transform duration-300 hover:rotate-[360deg]">
          ...
          <a href="#" aria-label="Discord" className="transition-transform duration-300 hover:rotate-[360deg]">
          ...
          <a href="#" aria-label="Dribbble" className="transition-transform duration-300 hover:rotate-[360deg]">
          ...
          <a href="#" aria-label="Youtube" className="transition-transform duration-300 hover:rotate-[360deg]">
